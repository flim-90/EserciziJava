	...
	public void superiorita(Aereomobile aereomobile) {
		try {
			if (this.efficenzaAereodinamica > ((Aliante) aereomobile).efficenzaAereodinamica) {
				...
				System.out.println("Il tuo AereoMotore è piu' potente di: "
						+ (this.efficenzaAereodinamica - ((Aliante) aereomobile).efficenzaAereodinamica));

			} else {

				System.out.println("Il tuo AereoMotore è meno potente di: "
						+ ((((Aliante) aereomobile).efficenzaAereodinamica) - this.efficenzaAereodinamica));
